...
# For each preprocessed DataFrame, append to the preprocessed_list
...
for i in preprocessed_data_list:
    ...
    DecisionTree_Entropy(9)    # K-Fold Cross Validation
    DecisionTree_Gini(9)       # K-Fold Cross Validation
    SVM(9)                     # K-Fold Cross Validation
    LogisticReg(9)             # K-Fold Cross Validation
    Dataset_Num = Dataset_Num + 1

# Get Final Result (According to Best Score, print same index of lists.)
print('\n################## Result ######################')
print('The Best Accuracy among the combinations : ', max(TestSetScore_list))
print('The Parameters of Best Score : ', Best_Parameters_list[TestSetScore_list.index(max(TestSetScore_list))])
print('The Best of Model : ', Best_Accuracy_list[TestSetScore_list.index(max(TestSetScore_list))])
